...
define("EW_CONN_USER", "innova", TRUE);
define("EW_CONN_PASS", "kifayat123", TRUE);
define("EW_CONN_DB", "innova_kizmo", TRUE);
...
define("EW_PROJECT_NAME", "CourseOutlines", TRUE); // Project Name
define("EW_RANDOM_KEY", '$A9aMMvGBkPbXI8P', TRUE); // Random key for encryption
